(function () {
    ...
    dashboard_home.component('budgetTable',{
                templateUrl : 'public/account/dashboard/_dashboard_files/components/budget_table.template.html',
...
dashboard_home.controller('ExampleController2', function($scope, $mdEditDialog,$timeout){
