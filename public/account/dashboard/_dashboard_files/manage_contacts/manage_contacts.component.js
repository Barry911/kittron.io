...
(function () {
    "use strict";
    var dashboard_contacts = angular.module('dashboardContacts');

    dashboard_contacts.component('dashboardContacts',{
        templateUrl : 'public/account/dashboard/_dashboard_files/manage_contacts/manage_contacts.template.html',
        controller:  function ($mdSidenav, $scope, $timeout, $mdDialog){
    ...
    dashboard_contacts.component('contactsTable',{
        templateUrl : 'public/account/dashboard/_dashboard_files/manage_contacts/contacts_table.template.html',
